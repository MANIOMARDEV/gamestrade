...
<p align="center">
  gamestrade built with React
</p>

## Short Description
An e-commerce store, imitating a gamestrade, built with React. Includes dedicated game pages, a search functionality, genre and rating filters, a like feature and a wishlist. Responsive to the bone and tested with Jest. You can find a list of [features](#features), [performance tests](#performance) and [technologies used](#technologies-used) below.

## 🔴 Demo
🧪 [Live Demo](https://github.com/MANIOMARDEV/) available. Click "Live Demo" to open it.
